...
class ProductList
{
     ...
     * @return string
     */
    public function afterGetTemplate(WidgetList $subject, $result): string
    {
        return 'MageINIC_QuickView::catalog/product/widget/grid.phtml';
    }
}
